...
const profileSchema = z.object({
    ...
    locatie: z.string().min(2, "Locatia trebuie sa aiba cel putin 2 caractere").max(50, "Locatia nu poate avea mai mult de 50 de caractere")
})
...
export default function EditeazaProfilulBtn({ session } : { session: User }) {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const request = async () => {
            ...
            await editeazaProfilul(userInfo.fizic, userInfo.sex, userInfo.varsta, userInfo.stilSportiv, userInfo.kg, userInfo.locatie)
        }
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
                            ...
                            <Input value={userInfo.locatie} onChange={(e) => updateUserInfo('locatie', e.target.value)} type='text' label='Locatie' name='locatie' className='text-black' />
